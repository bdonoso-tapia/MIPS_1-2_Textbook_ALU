...
set outputdir "./vivado_generated_alu"

# Set to top level entity name - entity to be used by the board 
set topLevelModuleName "alu_textook_board_top" 

# Set this to the top level entity name in your simulation testbench vhdl file or set to "" if no testbench
set topLevelTestbenchModuleName "sim_textbook_alu"

# Set this to the name of your  simulation testbench vhdl file or leave as "" if no test bench
set simulationTestbench "./sim_testbench/sim_textbook_alu.vhd"
